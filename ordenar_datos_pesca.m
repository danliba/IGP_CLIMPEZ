...
%% este codigo funciona 2003 hasta 2015 agosto
...
for ifloat=1:1:size(hdir,1)
   ...
   % Find indices that match the pattern
    ...
    %sumamos todos los NaN en el array
    ...
    new_array4=new_array3(1:min(indxnan)-2,:);
...
%save('TrueFishdatabase_2003_2015.mat','sortedtiempo','sortedspecies','sortedpuertos','sorteddata_fish');
