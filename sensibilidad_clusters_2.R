...
#aguas altas
data1<-read_excel("C1_abr_mayo_sed_caud_aguas_altas.xlsx", sheet = 1)
View(data1)
jj<-1 #cambiar a 0 cuando se requiera el año 2015
...
## aguas bajas
data2<-read_excel("C1_B_Ago_Set_sed_caud_aguas_bajas.xlsx", sheet = 1)
View(data2)
...
groupe<-cutree(GA3,3);groupe

######################

datfis2<-data_fisica2[-c(2)]
